...
#define _HI_RS()    _HI(SSD_RES)
#define _LO_RS()    _LO(SSD_RES)
#define _HI_DC()    _HI(SSD_DC)
#define _LO_DC()    _LO(SSD_DC)
#define _HI_CS()    _HI(SPI1_NSS)
#define _LO_CS()    _LO(SPI1_NSS)
